        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              <strong>Sweden, Stockholm</strong>  <br/>but always ready to move where the work is.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              <strong>React  Next.js  bootstrap  material UI</strong> 
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              <strong>Coding, Hardware, Travel, Speed-Skating.</strong> 
            </div>
          </div>
        </div>
      </div>
